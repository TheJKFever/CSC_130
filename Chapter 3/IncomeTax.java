...
public class IncomeTax
{
	public static void main(String[] args)
	{
		...
		double income, tax, taxPercent=0;
		
		income = Integer.parseInt(JOptionPane.showInputDialog("Hey " + american + "!\nHope you made some money this year, because"
			+ "\nthe government's coming to collect their share."
